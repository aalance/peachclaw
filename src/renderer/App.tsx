...
import PetSettingsView from './components/pet/PetSettingsView';
...
const App: React.FC = () => {
  ...
  const [mainView, setMainView] = useState<'cowork' | 'skills' | 'scheduledTasks' | 'kits' | 'mcp' | 'pet'>('cowork');
