...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    petHide: '隐藏桌宠',
    petPageTitle: '桌宠',
    petPageSubtitle: '定制你的桌面伙伴，查看经验与消耗统计',
    petSectionDisplay: '显示',
    petSectionStats: '成长与统计',
    petSectionAppearance: '外观',
    petVisibleLabel: '在桌面显示桌宠',
    petLevel: '等级',
    petExp: '经验',
    petTokenUsage: '累计消耗 Token',
    petTaskCount: '完成任务',
    petEnergy: '活力',
    petMood: '心情',
    petMoodHappy: '开心',
    petMoodFocused: '专注',
    petMoodTired: '疲惫',
    petRecentRewards: '最近奖励',
    petNoRewards: '还没有奖励，去和桌宠聊聊吧。',
    petBuiltInPacks: '内置素材',
    petCustomUpload: '上传自定义素材',
    petUploadHint: '上传一张精灵图（推荐 8 列 × 9 行，例如 Peach 默认 1536×1872），设置网格并为每个动作选择帧。',
    petColumns: '列数',
    petRows: '行数',
    petUploadButton: '选择图片',
    petActionIdle: '待机',
    petActionRun: '奔跑（干活）',
    petActionListen: '倾听（等待输入）',
    petActionTalk: '说话',
    petActionThink: '思考',
    petActionWave: '挥手',
    petSave: '保存并应用',
    petReset: '恢复默认',
    petFramesLabel: '帧序号（用逗号分隔）',
    petFpsLabel: '帧率',
    petApplied: '已保存并应用到桌宠',
    petSectionVoice: '语音',
    petVoiceEnableLabel: '让桌宠说话（朗读回复）',
    petVoiceSelectLabel: '音色',
    petVoiceSystemDefault: '系统默认',
    petVoiceRate: '语速',
    petVoicePitch: '音调',
    petVoiceVolume: '音量',
    petVoicePreview: '试听',
    petVoicePreviewText: '你好，我是你的桌面伙伴，现在我会说话啦。',
    petVoiceEngineLabel: '语音引擎',
    petVoiceEngineSystem: '系统音色',
    petVoiceEngineMoss: 'MOSS-TTS-Nano（本地服务）',
    petVoiceMossHint: '需先在本地运行 MOSS-TTS-Nano 服务（python app.py），再填入下方地址。',
    petVoiceMossServerUrl: '服务地址',
    petVoiceMossVoice: '音色',
    petVoiceMossCustom: '自定义（上传我的录音）',
    petVoiceMossPickAudio: '选择参考录音',
    petVoiceMossReplaceAudio: '更换',
    petVoiceMossClearAudio: '改回预设',
    petVoiceMossCustomHint: '用这段录音克隆音色。建议 5-15 秒、清晰无噪音的单人说话。',
    petVoiceMossConverting: '正在转换录音…',
    petVoiceMossAudioReady: '已使用我的录音',
    petVoiceMossTest: '测试连接',
    petVoiceMossTesting: '正在连接…',
    petVoiceMossTestOk: '连接成功',
    petVoiceMossError: 'MOSS 语音出错',
    petVoiceMossFullLabel: '朗读完整回复',
    petVoiceMossFullHint: '关闭时只念开头一两句（更快、无停顿）；开启后完整朗读，句子之间可能有停顿。',
  ...
  en: {
    ...
    petShow: 'Show Pet',
    petHide: 'Hide Pet',
    petPageTitle: 'Desktop Pet',
    petPageSubtitle: 'Customize your desktop companion; view experience and token usage',
    petSectionDisplay: 'Display',
    petSectionStats: 'Growth & Stats',
    petSectionAppearance: 'Appearance',
    petVisibleLabel: 'Show pet on the desktop',
    petLevel: 'Level',
    petExp: 'EXP',
    petTokenUsage: 'Total Tokens',
    petTaskCount: 'Tasks Done',
    petEnergy: 'Energy',
    petMood: 'Mood',
    petMoodHappy: 'Happy',
    petMoodFocused: 'Focused',
    petMoodTired: 'Tired',
    petRecentRewards: 'Recent Rewards',
    petNoRewards: 'No rewards yet — go chat with your pet.',
    petBuiltInPacks: 'Built-in Packs',
    petCustomUpload: 'Upload Custom Asset',
    petUploadHint: 'Upload a spritesheet (recommended 8 cols × 9 rows, e.g. the default Peach 1536×1872), set the grid and pick frames for each action.',
    petColumns: 'Columns',
    petRows: 'Rows',
    petUploadButton: 'Choose Image',
    petActionIdle: 'Idle',
    petActionRun: 'Run (working)',
    petActionListen: 'Listen (awaiting input)',
    petActionTalk: 'Talk',
    petActionThink: 'Think',
    petActionWave: 'Wave',
    petSave: 'Save & Apply',
    petReset: 'Reset to Default',
    petFramesLabel: 'Frame indices (comma-separated)',
    petFpsLabel: 'FPS',
    petApplied: 'Saved and applied to the pet',
    petSectionVoice: 'Voice',
    petVoiceEnableLabel: 'Let the pet speak (read replies aloud)',
    petVoiceSelectLabel: 'Voice',
    petVoiceSystemDefault: 'System default',
    petVoiceRate: 'Rate',
    petVoicePitch: 'Pitch',
    petVoiceVolume: 'Volume',
    petVoicePreview: 'Preview',
    petVoicePreviewText: 'Hi, I am your desktop companion, and now I can talk.',
    petVoiceEngineLabel: 'Voice engine',
    petVoiceEngineSystem: 'System voice',
    petVoiceEngineMoss: 'MOSS-TTS-Nano (local server)',
    petVoiceMossHint: 'Run a local MOSS-TTS-Nano server first (python app.py), then enter its address below.',
    petVoiceMossServerUrl: 'Server URL',
    petVoiceMossVoice: 'Voice',
    petVoiceMossCustom: 'Custom (upload my recording)',
    petVoiceMossPickAudio: 'Choose a reference recording',
    petVoiceMossReplaceAudio: 'Replace',
    petVoiceMossClearAudio: 'Use a preset',
    petVoiceMossCustomHint: 'Clones the voice from this recording. 5-15s of clear single-speaker audio works best.',
    petVoiceMossConverting: 'Converting the recording…',
    petVoiceMossAudioReady: 'Using my recording',
    petVoiceMossTest: 'Test connection',
    petVoiceMossTesting: 'Connecting…',
    petVoiceMossTestOk: 'Connected',
    petVoiceMossError: 'MOSS voice error',
    petVoiceMossFullLabel: 'Read the full reply',
    petVoiceMossFullHint: 'Off: only the opening sentence or two (fast, no pauses). On: the whole reply, with pauses between sentences.',
