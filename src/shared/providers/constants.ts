...
export const ProviderName = {
  ...
  PlatformModelProvider: 'platform-model-provider',
} as const;
...
const PROVIDER_DEFINITIONS = [
  ...
  {
    id: ProviderName.PlatformModelProvider,
    label: 'PlatformModelProvider',
    openClawProviderId: OpenClawProviderId.PlatformModelProvider,
    defaultBaseUrl: 'https://api.example.com/openclaw',
    defaultApiFormat: ApiFormat.OpenAI,
    codingPlanSupported: false,
    region: 'global',
    enPriority: 0,
    defaultModels: [
      { id: 'platform-default', name: 'Platform Default', supportsImage: true },
    ],
  },
  {
