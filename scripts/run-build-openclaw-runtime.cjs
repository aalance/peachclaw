...
function resolveBashExecutable(rootDir) {
  ...
  //    WSL exposes two launchers that must both be rejected:
  //      - %LOCALAPPDATA%\Microsoft\WindowsApps\bash.exe (app execution alias)
  //      - C:\Windows\System32\bash.exe (legacy WSL launcher)
  //    Neither is Git Bash; running them with no distro fails with
